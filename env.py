...
class Env(object):
    ...
    def step(self, idx):
        ...
        b, n = torch.where(torch.logical_and(self.time_demand[:, :self.n_nodes-1, 0] >self.cur_time[:, None].repeat_interleave(self.n_nodes-1, axis=1), 
